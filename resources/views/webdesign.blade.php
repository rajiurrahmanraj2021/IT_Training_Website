      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="latest_banner_text">
            <h2> ওয়েবসাইট ডিজাইন সার্ভিস ডিটেইলস </h2>
          </div>
        </div>
      </div>
    </div>
                              ...
                              <div class="row">
                                      ...
                                      <div class="card p-2" style="overflow: hidden; border: 2px solid #ddd; box-shadow: 0px 0px 7px 2px #cfcdcd;">
                                          <div class="l_news">
                                              <div class="l_img" style="border-bottom:1px solid #c3c7c9;margin-bottom: 5px; width: 100%">
                                                  <img src="{{ asset('frontend_assets') }}/img/1ecom.jpg" alt="" class="img-fluid">
                                              </div>
                                              <div class="l_heading">
                                  ...
                                  <div class="col-lg-6 mb-4">
                                      <div class="card p-2" style="overflow: hidden; border: 2px solid #ddd; box-shadow: 0px 0px 7px 2px #cfcdcd;">
                                          <div class="l_news">
                                              <div class="l_img" style="border-bottom:1px solid #c3c7c9;margin-bottom: 5px; width: 100%">
                                                  <img src="{{ asset('frontend_assets') }}/img/angio.jpg" alt="" class="img-fluid">
                                              </div>
                                              <div class="l_heading">
                                  ...
                                  <div class="col-lg-6 mb-4">
                                      <div class="card p-2" style="overflow: hidden; border: 2px solid #ddd; box-shadow: 0px 0px 7px 2px #cfcdcd;">
                                          <div class="l_news">
                                              <div class="l_img" style="border-bottom:1px solid #c3c7c9;margin-bottom: 5px; width: 100%">
                                                  <img src="{{ asset('frontend_assets') }}/img/newspaper.jpg" alt="" class="img-fluid">
                                              </div>
                                              <div class="l_heading">
                                  ...
                                  <div class="col-lg-6 mb-4">
                                      <div class="card p-2" style="overflow: hidden; border: 2px solid #ddd; box-shadow: 0px 0px 7px 2px #cfcdcd;">
                                          <div class="l_news">
                                              <div class="l_img" style="border-bottom:1px solid #c3c7c9;margin-bottom: 5px; width: 100%">
                                                  <img src="{{ asset('frontend_assets') }}/img/portfolio.jpg" alt="" class="img-fluid">
                                              </div>
                                              <div class="l_heading">
                                  ...
                                  <div class="col-lg-6 mb-4">
                                      <div class="card p-2" style="overflow: hidden; border: 2px solid #ddd; box-shadow: 0px 0px 7px 2px #cfcdcd;">
                                          <div class="l_news">
                                              <div class="l_img" style="border-bottom:1px solid #c3c7c9;margin-bottom: 5px; width: 100%">
                                                  <img src="{{ asset('frontend_assets') }}/img/photography.jpg" alt="" class="img-fluid">
                                              </div>
                                              <div class="l_heading">
                                  ...
                                  <div class="col-lg-6 mb-4">
                                      <div class="card p-2" style="overflow: hidden; border: 2px solid #ddd; box-shadow: 0px 0px 7px 2px #cfcdcd;">
                                          <div class="l_news">
                                              <div class="l_img" style="border-bottom:1px solid #c3c7c9;margin-bottom: 5px; width: 100%">
                                                  <img src="{{ asset('frontend_assets') }}/img/constraction.jpg" alt="" class="img-fluid">
                                              </div>
                                              <div class="l_heading">
                                  ...
                                  <div class="col-lg-6 mb-4">
                                      <div class="card p-2" style="overflow: hidden; border: 2px solid #ddd; box-shadow: 0px 0px 7px 2px #cfcdcd;">
                                          <div class="l_news">
                                              <div class="l_img" style="border-bottom:1px solid #c3c7c9;margin-bottom: 5px; width: 100%">
                                                  <img src="{{ asset('frontend_assets') }}/img/recipi.jpg" alt="" class="img-fluid">
                                              </div>
                                              <div class="l_heading">
